...
df_projectlines["totalexlvat"] = pd.to_numeric(df_projectlines["sellingprice"], errors="coerce").fillna(0) * pd.to_numeric(df_projectlines["amount"], errors="coerce").fillna(0)
