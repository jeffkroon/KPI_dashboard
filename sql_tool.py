...
from data.business_data import get_kpi_data
...
# Use get_kpi_data from data.business_data
kpi_data = get_kpi_data(source='myfactory')
# Use kpi_data in your agent/task logic